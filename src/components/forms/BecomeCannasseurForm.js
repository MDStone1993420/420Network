  ...
  handleSubmit(event) {
    ...
    this.state.web3.fourtwenty.getAccounts((error, accounts) => {
      cannasseurRewards.deployed().then((instance) => {
        ...
        var rawTx = txutils.functionTx(cannasseurNetworkInstance.abi, 'becomeCannasseur', this.state.address, txOptions);
        ...
        <div>
          ...
          <Grid item xs={12} >
            ...
            <Grid item xs={12}>
              ...
              <Grid item xs={12}>
                <Button raised type="submit" color="primary">Become a Cannasseur!</Button>
